...
class ParkingSystem {
        ...
        private AtomicInteger big;
        private AtomicInteger medium;
        private AtomicInteger small;
    ...
    public boolean addCar(int carType) {
        switch (carType) {
            case 1:
                ...
                return big.getAndDecrement() > 0;
            case 2:
                if (medium.get() <= 0) {
                    return false;
                }
                return medium.getAndDecrement() > 0;
            default:
                if (small.get() <= 0) {
                    return false;
                }
                return small.getAndDecrement() > 0;
        }
    }
}
